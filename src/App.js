      ...
      <table>
        ...
        <tbody className="tbody">
          {users.map(details=>(
            <tr key={details.id}>
              <td>{details.id}</td>
              <td>{<img src={details.image} alt={"/"} width="70" height="70" />}</td>
              ...
              <td>{details.eyeColor}</td>
              <td>{details.hair.color}</td>
              <td>{details.hair.type}</td>
              <td>{details.domain}</td>
              <td>{details.ip}</td>
              <td>{details.address.address}</td>
              <td>{details.address.city}</td>
              <td>{details.address.coordinates.lat + "," + details.address.coordinates.lng}</td>
              <td>{details.address.postalCode}</td>
              <td>{details.address.state}</td>
              <td>{details.macAddress}</td>
              <td>{details.university}</td>
              <td>{details.bank.cardExpire}</td>
              <td>{details.bank.cardNumber}</td>
              <td>{details.bank.cardType}</td>
              <td>{details.bank.currency}</td>
              <td>{details.bank.iban}</td>
              <td>{details.company.address.address}</td>
              <td>{details.company.address.city}</td>
              <td>{details.company.address.coordinates.lat + "," + details.company.address.coordinates.lng}</td>
              <td>{details.company.address.postalCode}</td>
              <td>{details.company.address.state}</td>
              <td>{details.company.department}</td>
              <td>{details.company.name}</td>
              <td>{details.company.title}</td>
              <td>{details.ein}</td>
              <td>{details.ssn}</td>
